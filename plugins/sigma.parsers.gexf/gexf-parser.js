;(function(undefined) {
  ...
  function Node(properties) {
    ...
    //Yezan edit
    var node = new YNode(properties.id, properties.label, properties.size);
  ...
  // after Yezan Edit
    var edge = new YEdge(properties.id, properties.source, properties.target, properties.weight);
    edge.type = properties.type || 'undirected';
    edge.label = properties.label || edge.label;
